layui.define(function (exports) {
    var config = {
        // base_server: 'http://gateway.cross.echosite.cn/', // 接口地址，实际项目请换成http形式的地址 http://106.13.3.200:80/	http://127.0.0.1:9200/ 废弃
        // eureka_server: 'http://gateway.cross.echosite.cn/', // eureka注册中心地址				http://106.13.3.200:80/	http://127.0.0.1:9200/ 废弃

        // base_server: 'http://gateway.hjting.com/', // 接口地址，线上环境
        // eureka_server: 'http://gateway.hjting.com/', // eureka注册中心地址，线上环境
        base_server: 'http://127.0.0.1:9200/', // 接口地址，开发环境
        eureka_server: 'http://127.0.0.1:1111/', // eureka注册中心地址，开发环境
